...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtextFieldUserAmaterno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtextFieldUserAmaternoActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel8, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 182, Short.MAX_VALUE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(botonRegistrarUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
                .addGap(27, 27, 27)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jtextFieldUserDomicilio, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel11, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jLabel6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 299, Short.MAX_VALUE)
        ...
        jPanelUsuariosLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelUsuariosLayout.createSequentialGroup()
                ...
                .addGroup(jPanelUsuariosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPaneRegistroUsuarios, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 938, Short.MAX_VALUE)
        ...
        jPanelCobrosLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelCobrosLayout.createSequentialGroup()
                .addGroup(jPanelCobrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPaneUsuarios, javax.swing.GroupLayout.DEFAULT_SIZE, 950, Short.MAX_VALUE)
        ...
        jPanelPagosLayout.setHorizontalGroup(
            ...
            .addComponent(jScrollPanePagos, javax.swing.GroupLayout.DEFAULT_SIZE, 962, Short.MAX_VALUE)
        ...
        jTabbedPane1.addTab("RESIBOS DE PAGOS", jPanelPagos);
    ...
    // Validaciones
    // Validar numero_cliente
    if (jtextFieldUserNoCliente.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "El número de cliente es obligatorio.");
        return;
    }
    try {
        Integer.parseInt(jtextFieldUserNoCliente.getText());
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(null, "El número de cliente debe ser un valor numérico.");
        return;
    }

    // Validar numero_contrato
    if (jtextFieldUserNoContrato.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "El número de contrato es obligatorio.");
        return;
    }
    try {
        Integer.parseInt(jtextFieldUserNoContrato.getText());
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(null, "El número de contrato debe ser un valor numérico.");
        return;
    }

    // Validar nombre
    if (jtextFieldUserNombre.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "El nombre del usuario es obligatorio.");
        return;
    }

    // Validar apellido paterno
    if (jtextFieldUserApaterno.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "El apellido paterno es obligatorio.");
        return;
    }

    // Validar apellido materno (opcional)
    if (jtextFieldUserAmaterno.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "El apellido materno es obligatorio.");
        return;
    }
// Validar teléfono (opcional pero numérico)
       if (!jtextFieldUserTelefono.getText().trim().isEmpty()) {
        try {
            Long.parseLong(jtextFieldUserTelefono.getText());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "El teléfono debe ser un valor numérico.");
            return;
        }
    }
       
    // Validar barrio
    if (jtextFieldUserBarrio.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "El barrio es obligatorio.");
        return;
    }
    
        try {
        Integer.parseInt(jtextFieldUserBarrio.getText());
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(null, "El barrio debe ser un valor numérico.");
        return;
    }
    // Validar domicilio
    if (jtextFieldUserDomicilio.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "El domicilio es obligatorio.");
        return;
    }


    // Validar descuento
    if (jComboBoxDescuentos.getSelectedItem() == null) {
        JOptionPane.showMessageDialog(null, "Debe seleccionar un descuento.");
        return;
    }

    // Validar tarifa
    if (jComboBoxTarifas.getSelectedItem() == null) {
        JOptionPane.showMessageDialog(null, "Debe seleccionar una tarifa.");
        return;
    }

    // Si todas las validaciones pasan, registrar usuario
    int idUsuario = instanciaUsuarios.registrarUsuario(
            jtextFieldUserNoCliente.getText(),
            jtextFieldUserNoContrato.getText(),
            jtextFieldUserNombre.getText(),
            jtextFieldUserApaterno.getText(),
            jtextFieldUserAmaterno.getText(),
            jtextFieldUserDomicilio.getText(),
            jtextFieldUserTelefono.getText(),
            jtextFieldUserBarrio.getText(),
            jComboBoxDescuentos.getSelectedItem().toString(),
            jComboBoxTarifas.getSelectedItem().toString()
    );

    // Mostrar al usuario registrado en la tabla
    instanciaFiltrado.mostrarUsuario_al_Registrar(idUsuario, tablaRegistroUsuarios);

    // Resetear los campos de entrada
    jtextFieldUserNoCliente.setText("");
    jtextFieldUserNoContrato.setText("");
    jtextFieldUserNombre.setText("");
    jtextFieldUserApaterno.setText("");
    jtextFieldUserAmaterno.setText("");
    jtextFieldUserDomicilio.setText("");
    jtextFieldUserTelefono.setText("");
    jtextFieldUserBarrio.setText("");

    // Recargar los valores de los ComboBoxes
    instanciaComboBoxUsuarios.mostrarDescuentos(jComboBoxDescuentos);
    instanciaComboBoxUsuarios.mostrarTarifas(jComboBoxTarifas);
    ...
    private void jtextFieldUserAmaternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtextFieldUserAmaternoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtextFieldUserAmaternoActionPerformed
